...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Auryc initialize:@"66d5eb3cef0adf784a7fd477eb7bea2b" siteId:@"346-auryccom"];
    
    [[Auryc mainInstance] identify:@"adriana.fuentes@gmail.com"];
    
    [[Auryc mainInstance] addUserProperties:@{ @"age":@"19", @"gender":@"female"}];
