...
- (void)awakeFromNib
{
    ...
    self.posterImageView.accessibilityIdentifier = @"posterImageView";
    ...
    self.bookmarkButton.accessibilityIdentifier = @"bookmark";
    self.watchTrailerButton.accessibilityIdentifier = @"watchTrailer";
    self.movieTitleLabel.accessibilityIdentifier = @"movieTitleLabel";
...
- (IBAction)buyTickets:(id)sender{
    ...
    [auryc track:@"Tap:Buy Tickets" properties:@{ @"movieTitle":self.movieTitleLabel.text}];
}
